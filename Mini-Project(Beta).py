...
def clean_city(df):
    ...
    df['city'] = df['city'].replace({'ny': 'New York', 'nyc': 'New York City', 'sf': 'San Francisco', 'la': 'Los Angeles', 'chi': 'Chicago',
                                     'bos': 'Boston', 'sea': 'Seattle', 'den': 'Denver', 'por': 'Portland', 'mia': 'Miami', 'pho': 'Phoenix',
